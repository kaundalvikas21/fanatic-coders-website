...
export function ServicesCtaSection() {
  return (
    <section id="services-cta" className="py-24 relative overflow-hidden" style={{ background: "var(--dark-2)" }}>
      ...
      <div className="relative z-10 container mx-auto px-4">
        <RevealSection className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full text-sm font-mono mb-8 badge-aurora">
            ...
            <span className="text-blue-200/80">./scope-your-build.sh</span>
          </div>
          ...
          <p className="text-lg text-blue-100/65 mb-10 max-w-2xl mx-auto">
            Tell us the problem, not the spec. We&apos;ll recommend the right mix of services and a
            clear plan to get you there.
          </p>
