...
const reasons: Reason[] = [
  {
    ...
    description:
      'The people who scope your project are the people who build it. No bait-and-switch.',
    Icon: UserCheck,
  },
  {
    id: 'speed',
    title: 'Weekly shipping',
    description: 'You see working software every week, with demos and staging links from day one.',
    Icon: Gauge,
  },
  {
    id: 'ownership',
    title: 'We own outcomes',
    description: 'Performance, accessibility, and uptime are part of the deal, not an upsell.',
    Icon: ShieldCheck,
  },
  {
    id: 'pricing',
    title: 'Transparent pricing',
    description: 'Clear scope and predictable cost agreed before a line of code is written.',
    Icon: Receipt,
  },
];
      ...
      <div className="relative z-10 container mx-auto px-4">
        <RevealSection>
          <SectionHeading
            ...
            title={
              <>
                why.<span className="function">chooseUs</span>()
              </>
            }
