...
const models: Model[] = [
  ...
  },
  {
    ...
    included: ["Senior developers", "Your tools and process", "Flexible ramp up", "Knowledge transfer"],
    Icon: Users,
    accent: "green",
  },
]
...
export function ServicesEngagementSection() {
  return (
    <section id="engagement" className="section-y relative overflow-hidden" style={{ background: "var(--dark-3)" }}>
      ...
      <div className="relative z-10 container mx-auto px-4">
        <RevealSection>
          <SectionHeading
            ...
            title={<>how.to.<span className="function">work</span>().withUs()</>}
            comment="// three ways to bring us in"
          />
        </RevealSection>

        <RevealSection stagger className="mt-14 grid md:grid-cols-3 gap-5 max-w-6xl mx-auto">
          {models.map((model) => {
            const color = iconColor[model.accent]
            return (
              <div key={model.id} className="bento-card rounded-2xl p-7" style={accentVars(model.accent)}>
