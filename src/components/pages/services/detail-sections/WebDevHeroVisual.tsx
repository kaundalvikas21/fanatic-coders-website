...
export default function WebDevHeroVisual() {
  ...
  return (
    <div
      aria-hidden
      className="shrink-0 origin-center scale-[0.82] lg:scale-90 xl:scale-100"
    ...
    >
      ...
      <div style={{ position: "relative", paddingTop: 90 }}>
        <div style={{ position: "relative", width: 470, height: 380, transformStyle: "preserve-3d" }}>
          ...
          <div style={{ position: "absolute", left: 50, top: 70, width: 380, height: 240, borderRadius: 24, background: "linear-gradient(135deg,#5b7cff,#8b5cf6)", filter: "blur(40px)", opacity: 0.3, transform: "translateZ(-90px)" }} />
          ...
          <div style={{ position: "absolute", left: 10, bottom: 26, width: 140, height: 80, borderRadius: 14, background: "linear-gradient(180deg,#2c2b40,#1d1c2c 46%,#121120)", border: "1px solid rgba(150,140,215,.22)", boxShadow: "0 22px 44px -18px rgba(0,0,0,.85),inset 0 1px 0 rgba(255,255,255,.08),inset 0 -4px 8px rgba(0,0,0,.45)" }}>
            ...
            <div className="wd-core" style={{ position: "absolute", right: 14, top: 14, width: 18, height: 18, borderRadius: "50%", background: "radial-gradient(circle at 40% 35%,#34d2e8,#0c2b30)" }} />
          ...
          <div style={{ position: "absolute", left: 72, top: 270, width: 0, height: 0, transformStyle: "preserve-3d" }}>
            ...
            <div style={{ ...joint, left: -19, top: -19, width: 38, height: 38, zIndex: 5 }}>
              ...
              <span style={{ position: "absolute", left: "50%", top: "50%", width: 6, height: 6, margin: -3, borderRadius: "50%", background: "#5b7cff", boxShadow: "0 0 8px #5b7cff" }} />
            </div>
            ...
            <div className="wd-arm" style={{ position: "absolute", left: -8, top: -15, width: 156, height: 30, transformOrigin: "16px 15px", transform: "rotate(-43deg)" }}>
              ...
              <div style={{ position: "absolute", left: 18, right: 16, top: "50%", height: 3, marginTop: -1.5, borderRadius: 2, background: "linear-gradient(90deg,#5b7cff,#8b5cf6)", boxShadow: "0 0 8px rgba(91,124,255,.5)", opacity: 0.85 }} />
              ...
              <div style={{ position: "absolute", left: 140, top: 15, width: 0, height: 0 }}>
                <div style={{ ...joint, left: -16, top: -16, width: 32, height: 32, zIndex: 4 }}>
                  ...
                  <span style={{ position: "absolute", left: "50%", top: "50%", width: 5, height: 5, margin: -2.5, borderRadius: "50%", background: "#8b5cf6", boxShadow: "0 0 8px #8b5cf6" }} />
                </div>
                ...
                <div className="wd-elbow" style={{ position: "absolute", left: -6, top: -13, width: 138, height: 26, transformOrigin: "6px 13px", transform: "rotate(36deg)" }}>
                  ...
                  <div style={{ position: "absolute", left: 14, right: 14, top: "50%", height: 3, marginTop: -1.5, borderRadius: 2, background: "linear-gradient(90deg,#8b5cf6,#5b7cff)", boxShadow: "0 0 8px rgba(139,92,246,.5)", opacity: 0.85 }} />
                  ...
                  <div style={{ position: "absolute", left: 128, top: 13, width: 0, height: 0, transform: "rotate(7deg)" }}>
                    ...
                    <div style={{ position: "absolute", left: 30, top: -62, width: 182, height: 124, borderRadius: 13, overflow: "hidden", background: "linear-gradient(165deg,rgba(24,22,44,.95),rgba(13,12,24,.97))", border: "1px solid rgba(91,124,255,.4)", boxShadow: "0 26px 60px -22px rgba(0,0,0,.85),0 0 30px rgba(91,124,255,.2),inset 0 1px 0 rgba(255,255,255,.07)", backdropFilter: "blur(10px)" }}>
                      ...
                      <div style={{ padding: 10 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 9 }}>
                          <span style={{ width: 15, height: 15, borderRadius: 5, background: "linear-gradient(135deg,#5b7cff,#8b5cf6)" }} />
                          <span style={{ width: 28, height: 6, borderRadius: 3, background: "rgba(205,206,230,.4)" }} />
                          <span style={{ flex: 1 }} />
                          <span style={{ width: 34, height: 13, borderRadius: 7, background: "linear-gradient(135deg,#5b7cff,#8b5cf6)" }} />
                        </div>
                        <div style={{ height: 48, borderRadius: 8, background: "linear-gradient(120deg,rgba(91,124,255,.26),rgba(139,92,246,.3) 70%)", border: "1px solid rgba(150,160,255,.16)", padding: 9, display: "flex", flexDirection: "column", gap: 5, justifyContent: "center", marginBottom: 8 }}>
                          ...
                          <span style={{ width: "42%", height: 7, borderRadius: 4, background: "linear-gradient(90deg,#5b7cff,#34d2e8)" }} />
                        </div>
                      ...
                      <div className="wd-scan" style={{ position: "absolute", left: 0, right: 0, top: 0, height: 30, background: "linear-gradient(rgba(52,210,232,0),rgba(52,210,232,.3))", borderBottom: "1.5px solid #34d2e8", boxShadow: "0 0 16px rgba(52,210,232,.6)", pointerEvents: "none" }} />
                      <span className="wd-tick" style={{ position: "absolute", left: 5, top: 5, width: 13, height: 13, borderLeft: "2px solid #34d2e8", borderTop: "2px solid #34d2e8" }} />
                      <span className="wd-tick" style={{ position: "absolute", right: 5, top: 5, width: 13, height: 13, borderRight: "2px solid #34d2e8", borderTop: "2px solid #34d2e8", animationDelay: ".3s" }} />
                      <span className="wd-tick" style={{ position: "absolute", left: 5, bottom: 5, width: 13, height: 13, borderLeft: "2px solid #34d2e8", borderBottom: "2px solid #34d2e8", animationDelay: ".6s" }} />
                      <span className="wd-tick" style={{ position: "absolute", right: 5, bottom: 5, width: 13, height: 13, borderRight: "2px solid #34d2e8", borderBottom: "2px solid #34d2e8", animationDelay: ".9s" }} />
                    </div>
                    <div style={{ position: "absolute", left: 30, top: -78, display: "inline-flex", alignItems: "center", gap: 6, fontSize: 10, letterSpacing: 1, color: "#5fd8ec", whiteSpace: "nowrap", textShadow: "0 0 8px rgba(52,210,232,.5)" }}>
                      <span className="wd-dot" style={{ width: 6, height: 6, borderRadius: "50%", background: "#34d2e8", boxShadow: "0 0 8px #34d2e8" }} />
                      RENDERING · Hero.jsx
                    </div>
                  </div>
                </div>
          ...
          <div className="wd-telemetry" style={{ position: "absolute", left: -26, top: 14, transform: "translateZ(60px)", width: 158, padding: "11px 13px", borderRadius: 11, background: "rgba(14,12,26,.82)", border: "1px solid rgba(139,92,246,.34)", boxShadow: "0 0 26px rgba(139,92,246,.16)", backdropFilter: "blur(8px)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 9.5, letterSpacing: 1, color: "#b3a6f0", marginBottom: 8 }}>
              <span>▸ BUILD QUEUE</span><span style={{ color: "#34d2e8" }}>98%</span>
            </div>
            <div style={{ height: 6, borderRadius: 4, background: "rgba(150,140,230,.12)", overflow: "hidden", marginBottom: 9 }}>
              <div className="wd-prog" style={{ height: "100%", borderRadius: 4, background: "linear-gradient(90deg,#5b7cff,#8b5cf6)" }} />
            </div>
          ...
          {/* floating chips */}
          <div className="wd-chip-a" style={{ position: "absolute", top: -14, right: 24, transform: "translateZ(80px)", display: "inline-flex", alignItems: "center", gap: 7, padding: "8px 13px", borderRadius: 999, background: "rgba(18,20,40,.82)", border: "1px solid rgba(91,124,255,.4)", color: "#9db2ff", fontSize: 12, whiteSpace: "nowrap", boxShadow: "0 0 24px rgba(91,124,255,.22)", backdropFilter: "blur(6px)" }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#5b7cff", boxShadow: "0 0 8px #5b7cff" }} />SERVO 98%
          </div>
          <div className="wd-chip-b" style={{ position: "absolute", bottom: -6, right: 54, transform: "translateZ(50px)", display: "inline-flex", alignItems: "center", gap: 7, padding: "8px 13px", borderRadius: 999, background: "rgba(14,28,32,.82)", border: "1px solid rgba(52,210,232,.4)", color: "#5fd8ec", fontSize: 12, whiteSpace: "nowrap", boxShadow: "0 0 24px rgba(52,210,232,.22)", backdropFilter: "blur(6px)" }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#34d2e8", boxShadow: "0 0 8px #34d2e8" }} />0.4s LCP
          </div>
        </div>
      </div>
    </div>
