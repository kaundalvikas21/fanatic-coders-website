      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 max-w-6xl">
        <RevealSection>
          <SectionHeading
            ...
            title={
              <>
                project.<span className="function">deliverables</span>()
              </>
            }
        ...
        <RevealSection
          as="ul"
          stagger
          className="mt-14 grid list-none sm:grid-cols-2 gap-4"
        >
          {serviceDeliverables.map((item, i) => (
            ...
            >
              <span
                className="font-mono text-lg font-bold tabular-nums leading-none pt-1.5"
                style={{ color }}
              >
