              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-4 text-sm text-blue-100/60">
                  <span className="flex items-center gap-1">
                    <Clock size={14} className="text-[var(--aurora-violet-light)]" aria-hidden />
                    {post.readTime}
                  </span>
                  <span className="flex items-center gap-1">
                    <Calendar size={14} className="text-[var(--aurora-violet-light)]" aria-hidden />
                    {post.date}
                  </span>
                </div>
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-bold leading-tight">
                  <Link href={`/blog/${post.slug}`} className="block no-underline text-white hover:text-[var(--aurora-violet-light)] transition-colors">
                    {post.title}
                  </Link>
                </h3>
