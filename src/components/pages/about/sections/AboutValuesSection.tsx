...
const values: Value[] = [
  { id: "craft", title: "Craft over shortcuts", description: "We sweat the details others skip: clean architecture, real tests, and interfaces that feel right.", accent: "violet" },
  { id: "speed", title: "Momentum every week", description: "Tight loops and weekly demos keep work visible and decisions fast. No black boxes.", accent: "cyan" },
  { id: "ownership", title: "We own outcomes", description: "Performance, accessibility, and uptime are ours to defend, not someone else's ticket.", accent: "green" },
  { id: "partnership", title: "True partnership", description: "One senior team, one point of contact, fully embedded in your goals and trade-offs.", accent: "violet" },
  { id: "transparency", title: "Open by default", description: "Open roadmaps, honest estimates, and pricing you can predict before we start.", accent: "cyan" },
  { id: "people", title: "People first", description: "Great products come from healthy teams. We hire well, mentor hard, and stay kind.", accent: "green" },
]
  ...
  return (
    <section id="values" className="section-y relative overflow-hidden" style={{ background: "var(--dark-2)" }}>
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          {values.map((value, i) => (
            <li key={value.id} className="group relative flex gap-5 pt-6">
