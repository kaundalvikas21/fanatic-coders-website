        ...
        <div className="max-w-6xl mx-auto">
          <RevealSection className="max-w-3xl">
            <SectionHeading
              ...
              title={
                <>
                  our.<span className="function">story</span>()
                </>
              }
              comment="// how we got here, since 2018"
            />
            <p className="mt-6 text-base sm:text-lg text-[var(--color-text-muted)] leading-relaxed">
              We did not start with a pitch deck. We started with code that had to work, for clients
              who needed it to. Here is the short version of how the team took shape.
            </p>
          </RevealSection>
