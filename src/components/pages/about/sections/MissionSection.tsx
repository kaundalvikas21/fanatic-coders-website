        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start max-w-6xl mx-auto">
          ...
          <RevealSection>
            <SectionHeading
              ...
              title={
                <>
                  why.<span className="function">weExist</span>()
                </>
              }
            ...
            <p className="mt-6 text-base sm:text-lg text-[var(--color-text-muted)] leading-relaxed">
              We started fanaticCoders because too much software ships slow and brittle. Our answer
              is small senior teams and tight feedback loops, with the product actually working for
              real users as the thing we measure.
            </p>
              ...
              <div className="p-6 md:p-8 font-mono text-sm leading-relaxed">
                {codeLines.map((line, i) => (
                  <div
                    ...
                    className={line.cls}
                  >
                    <span className="select-none text-white/20 mr-4">
