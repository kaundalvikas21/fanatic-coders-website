...
const valueProps: { Icon: LucideIcon; label: string; sub: string }[] = [
  { Icon: Code2, label: "By the people who ship", sub: "Working engineers and designers, not ghostwriters." },
  { Icon: BookOpen, label: "Real production lessons", sub: "Decisions from live projects, no filler." },
  { Icon: Compass, label: "Engineering, design, growth", sub: "Craft across the work we actually do." },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 flex w-full flex-1 flex-col justify-center">
        ...
        <RevealSection stagger className="mt-10 grid w-full max-w-4xl mx-auto grid-cols-2 lg:grid-cols-4 gap-3">
