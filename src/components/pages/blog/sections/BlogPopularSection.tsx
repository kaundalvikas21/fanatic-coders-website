    ...
    <section id="blog-popular" className="py-24 relative overflow-hidden" style={{ background: "var(--dark-3)" }}>
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-6xl">
        <RevealSection>
          <SectionHeading
            badge="posts.popular"
            title={<>popular.<span className="function">reads</span>()</>}
              ...
              <GlassCard lift className="h-full overflow-hidden flex flex-col transition-shadow group-hover/card:ring-1 group-hover/card:ring-indigo-400/30">
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-center gap-2 text-[11px] font-mono text-blue-100/55">
                    ...
                    <span className="h-1 w-1 rounded-full bg-blue-100/30" aria-hidden />
                    <span>{post.date}</span>
                  </div>
                  ...
                  <span className="mt-auto flex items-center gap-1.5 border-t border-white/5 pt-4 text-sm font-mono text-indigo-300">
                    Read article
                    <ArrowRight size={14} aria-hidden className="transition-transform group-hover/card:translate-x-1" />
                  </span>
                </div>
              </GlassCard>
            </Link>
