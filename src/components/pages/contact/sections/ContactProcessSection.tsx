...
const steps: Step[] = [
  {
    ...
    description: 'Share as much or as little as you have: a spec, a sketch, or just the problem.',
    Icon: MessageSquare,
    accent: 'violet',
  },
  {
    ...
    description: 'A free 30-minute call to understand goals, scope, timeline, and budget.',
    Icon: Phone,
    accent: 'cyan',
  },
  {
    ...
    description: 'We follow up with a written plan: scope, milestones, and transparent pricing.',
    Icon: FileText,
    accent: 'blue',
  },
  {
    n: '04',
    title: 'Kickoff',
    description: 'Agree the plan and we start shipping, with demos from the very first week.',
    Icon: Rocket,
    accent: 'green',
  },
];
      ...
      <div className="relative z-10 container mx-auto px-4">
        <RevealSection>
          <SectionHeading
            ...
            title={
              <>
                what.<span className="function">happensNext</span>()
              </>
            }
        ...
        <RevealSection
          stagger
          className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto"
        >
          {steps.map((step) => (
            <GlassCard
              key={step.n}
            ...
            >
              <div className="flex items-center justify-between">
                <span className="process-num text-4xl font-bold font-mono tabular-nums">
                  {step.n}
                </span>
                <step.Icon
                  size={22}
                  aria-hidden
                  style={{ color: `var(${ACCENT_VAR[step.accent]})` }}
                />
              </div>
