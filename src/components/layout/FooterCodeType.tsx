...
const SEGMENTS: Seg[] = [
  ...
  { t: "const ", cls: "text-pink-400" }, { t: "project", cls: "text-indigo-400" }, { t: " = {\n" },
  { t: "  team:  " },  { t: "'senior'",      cls: "text-rose-400" }, { t: ",       " }, { t: "// same folks who pitch, build\n", cls: C },
  { t: "  stack: " },  { t: "'your choice'", cls: "text-rose-400" }, { t: ",  " },      { t: "// we work in your tools\n", cls: C },
  { t: "  scope: " },  { t: "'clear'",       cls: "text-rose-400" }, { t: ",        " }, { t: "// plan before code\n", cls: C },
  { t: "  start: " },  { t: "'this week'",   cls: "text-rose-400" }, { t: ",\n" },
  { t: "}\n" },
...
export default function FooterCodeType() {
  ...
  for (const seg of SEGMENTS) {
    ...
    shown.split("\n").forEach((line, i) => {
      ...
      if (line) out.push(<span key={`s-${key++}`} className={seg.cls}>{line}</span>)
    })
  }
