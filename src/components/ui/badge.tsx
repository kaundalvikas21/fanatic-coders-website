...
function Badge({
  ...
  VariantProps<typeof badgeVariants> & {
    asChild?: boolean;
    color?: 'default' | 'blue' | 'green' | 'amber' | 'red' | 'gray';
  }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        color === 'blue' && 'bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300',
        color === 'green' && 'bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-300',
