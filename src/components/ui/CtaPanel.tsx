    ...
    >
      {!muted && (
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(124,58,237,0.10) 0%, transparent 60%)',
          }}
        />
      )}
          ...
          >
            <div
              ...
              style={{
                ...
                maskImage:
                  'radial-gradient(ellipse 75% 75% at 50% 50%, black 35%, transparent 80%)',
                WebkitMaskImage:
                  'radial-gradient(ellipse 75% 75% at 50% 50%, black 35%, transparent 80%)',
              }}
            />
            ...
            <div
              className={`relative z-[1] px-8 text-center ${muted ? 'py-10 md:py-12 md:px-16' : 'py-14 md:px-16 md:py-16'}`}
            >
